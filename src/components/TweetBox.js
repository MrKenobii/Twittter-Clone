    ...
    const sendTweet= () => {
        if(content !== ""){
            db.collection("feed").add({
                displayName: "Anıl Duyguç",
                username: "@generalKenbi",
                content,
                ...
                avatar: "https://pbs.twimg.com/profile_images/1365387574529978371/Wmo_8dXw_400x400.jpg"
            });
            setContent("");
        }
    };
  ...
  return (
    <div className="flex flex-col flex-1 mt-2 px-2">
      ...
      <div className="flex items-center justify-between">
        ...
        <button className="bg-primary-base text-white rounded-full px-4 py-2 font-medium" onClick={sendTweet}>
          Tweet
        </button>
      </div>
    </div>
